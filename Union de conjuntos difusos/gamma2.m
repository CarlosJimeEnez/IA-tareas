...
disp("Parametros de la grafica: k1 = 1, a1=4, k2 = 1, a2 = 13")
disp("Parametros de la grafica: k3 = 1, a3=10, k4 = 1, a4 = 19")
k1 = 1; a1=4;k2 = 1; a2=13;
k3 = 1; a3=10;k4 = 1; a4=19; 
disp("...........")

disp("Intervalo de las graficas = [4, 19]")
...
for i=1:cols
    if ts(:,i) <= a1
        ...
        u_gamma1(:,i) = (k1*(ts(:,i)-a1)^2)/(1+k1*(ts(:,i)-a1)^2);
    end
end
...
for i=1:cols
    if ts(:,i) >= a2
        ...
        u_gamma1_inv(:,i) = (k2*(ts(:,i)-a2)^2)/(1+k2*(ts(:,i)-a2)^2);
    end
end
...
for i=1:cols
    if ts(:,i) <= a3
        ...
        u_gamma2(:,i) = (k3*(ts(:,i)-a3)^2)/(1+k3*(ts(:,i)-a3)^2);
    end
end
...
for i=1:cols
    if ts(:,i) >= a4
        ...
        u_gamma2_inv(:,i) = (k4*(ts(:,i)-a4)^2)/(1+k4*(ts(:,i)-a4)^2);
    end
end
